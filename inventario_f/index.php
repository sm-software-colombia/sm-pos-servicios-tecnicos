...
<html lang="es">
  <head>
    ...
    <link rel="icon" type="image/png" sizes="64x64" href="./imagenes/favicon_final_1.png">
...
?>
          ...
          <form class="form-horizontal">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="q" placeholder="Ingresa nombre o codigo del producto que buscas" onkeyup="load(1)"><br><br>
            </div>
      
<button type="button" class="btn btn-sample" class="btn pull-right" data-toggle="modal" data-target="#dataRegister"><i class=''></i>Nuevo Ítem</button>
...
$('#dataUpdate').on('show.bs.modal', function (event) {
        ...
        var impuesto = button.data('impuesto') // Extraer la info
        var favorito = button.data('favorito') // Extraer la info
		  ...
		  modal.find('.modal-body #continente').val(continente)
		   modal.find('.modal-body #departamento').val(departamento)
		    ...
		    modal.find('.modal-body #impuesto').val(impuesto)
        modal.find('.modal-body #favorito').val(favorito)
