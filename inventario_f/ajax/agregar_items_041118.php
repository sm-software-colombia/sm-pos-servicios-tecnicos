...
<?php
	...
	$insert_tmp = mysqli_query($con, "INSERT INTO ostemporal_cotizaciones (id,titulo,come,celu,num,estado,impuesto,descuento) VALUES ('$id','$articulo','$cantidad','$session_id','$prec44','$codigo','$impuestos','$descuentoproducto')");
}
...
<tr>
	<td colspan=5><span class="pull-right" style="font-size: 130%">SUMA DESCUENTOS UNITARIOS</span></td>
	<td><span class="pull-right" style="font-size: 130%" ><?php echo "$";
echo number_format($descuento_final_suma);
?></span></td>
	<td></td>
</tr>
<tr>
...
<tr>
	...
	<td><span class="pull-right" style="font-size: 130%" ><?php echo "$";
echo number_format($suma-$descuento_final_suma);
?></span></td>
