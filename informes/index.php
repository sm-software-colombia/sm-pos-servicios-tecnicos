...
<!-- SE CIeRRa FORMULARIO-->
          ...
          <form class="form-horizontal">
            ...
            <div class="col-sm-6">
            <button type="button" class="btn btn-sample" class="btn pull-right" data-toggle="modal" data-target="#dataRegister2"><i class=''></i>Nueva Consulta</button>
       
            <br><br>
              <input type="text" class="form-control" id="q" placeholder="Ingresa la fecha del comprobante que buscas" onkeyup="load(1)"><br><br>
            </div>

        
            </div>
          </form>
          <h4> Comprobantes de Venta</h4>
